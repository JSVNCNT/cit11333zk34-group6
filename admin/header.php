...
<aside class="sidebar">
    ...
    <div class="sidebar-profile">
        ...
        <div class="avatar">
            <img
            src="../src/assets/images/hiro-avatar.png"
            alt="Avatar">
        </div>
    ...
    <nav class="sidebar-nav">
        ...
        <a
        href="subjects.php"
        class="nav-link <?= $active_page === 'subjects' ? 'active' : '' ?>">
        ...
        <a
        href="grades.php"
        class="nav-link <?= $active_page === 'grades' ? 'active' : '' ?>">
    ...
    <div class="sidebar-footer">
        ...
        PHP Student Dashboard v2.0

        <br>

        &copy; <?= date('Y') ?>

        CIT11333Z Final Project
